...
_C.MODEL.RFF = CN()
_C.MODEL.RFF.MC = 5
_C.MODEL.RFF.KERNEL_TYPE = "arccos"
...
_C.MODEL.VSSM.PARALLEL_SPLITS = [1, 1]
_C.MODEL.VSSM.DYNAMIC_WEIGHTING = False
_C.MODEL.VSSM.DYNAMIC_WEIGHT_REDUCTION = 4
_C.MODEL.VSSM.MSF_ENABLED = False
_C.MODEL.VSSM.MSF_SCALES = [1, 2, 4]
_C.MODEL.VSSM.GN_ENABLED = False
_C.MODEL.VSSM.GN_REDUCTION = 4
